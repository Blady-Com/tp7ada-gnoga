...
--
-- COPYRIGHT                        : (c) Pascal Pignard 2002-2015
...
package TP7.Graph is
   ...
   procedure FreeMem (P : in out BitMapType; Taille : Word);
   procedure GetMem (P : out BitMapType; Taille : Word);
   procedure GetImage (X1, Y1, X2, Y2 : Integer; BitMap : in out BitMapType);
   procedure PutImage (X, Y : Integer; BitMap : BitMapType; BitBlt : Word);
...
private
   type BitMapType is new Gnoga.Gui.Element.Canvas.Context_2D.Image_Data_Access;
end TP7.Graph;
